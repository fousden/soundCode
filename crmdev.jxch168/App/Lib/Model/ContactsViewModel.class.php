<?php
	class ContactsViewModel extends ViewModel {
	   public $viewFields = array(
		'contacts'=>array('contacts_id','creator_role_id','name','post','department','sex','saltname','telephone','email','qq','address','zip_code','description','reate_time','update_time','is_deleted','delete_role_id','delete_time','_type'=>'LEFT'),
