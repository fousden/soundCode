...
class Page {
    ...
    protected $coolPages   ;
    // 分页显示定制
	protected $config  =	array('header'=>'条记录','prev'=>'&laquo; 上一页','next'=>'下一页 &raquo;','first'=>'首页','last'=>'末页','theme'=>' <div style="height:36px;float:left;margin-top:5px;" class="pagination"><div style="width:120px;float:left;position:relative;top:9px;left:3%;">共%totalRow% %header% %nowPage%/%totalPage% 页</div><div style="position:relative;left:12%;top:4px;width:520px;float:left;"><div><style type="text/css">#pageul{width:120%;}</style><ul id="pageul"><li>%first%</li><li>%upPage%</li><li>%linkPage%</li><li>%downPage%</li><li>%end%</li><li style="position:relative;top:3px;">　　跳转至第%go%页</li></ul></div></div></div> ');
    // 默认分页变量名
    public $varPage;
