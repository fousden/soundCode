...
$(function(){
    selectChange($('[name=theme-select]').val("default"));
})
...
function selectChange(value){
    ...
    if (themeName != 'default') {
        ...
        require(['/front/echarts/js/theme/' + themeName], function(curTheme){
            theme = curTheme;
...
function download() {
    if (themeName) {
        window.open('/front/echarts/js/theme/' + themeName + '.js');
    }
}
...
if (developMode) {
    ...
    (function () {
        ...
        script.src = pathLevelArr.join('/front/echarts/') + 'asset/js/esl/esl.js';
