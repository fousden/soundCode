$(document).ready(function(){
    ...
    setTimeout(function(){
        $('.blackBox').fadeOut(100,getLoadBar);
    },1000);
            ...
            if(testMode){
                ...
                for(var i=0;i<lis.length;i++){
                    ...
                    $(lis[i]).on(touchend,function(){
                        ...
                        imgurl="../images/"+baoliuLi.attr('num')+".jpg";
                        wxDefault = {
                            title: "连"+tt+"都被它打败了！！",
                        ...
                        wxShare();
						$.get("http://didiapi.hecoe.com/didi2/Index/icosave.html",{name:tt});
    ...
    $('.page2_8').on(touchstart,function(){
       ...
       //下面的是原有的弹出图片的内容 begin
        ...
        window.location.href = "http://www.jxch168.com/wap/index.php?ctl=register";
    });
