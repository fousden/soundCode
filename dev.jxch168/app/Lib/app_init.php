...
//APP项目静态文件定义统一路径
$css = APP_ROOT."/front/css/";
$js = APP_ROOT."/front/js/";
$images = APP_ROOT."/front/images/";
$GLOBALS['tmpl']->assign("TMPL",$tmpl_path.app_conf("TEMPLATE"));
$GLOBALS['tmpl']->assign("JS",$js);
$GLOBALS['tmpl']->assign("CSS",$css);
$GLOBALS['tmpl']->assign("IAMGES",$images);
