...
class guaranteeModule extends SiteBaseModule{
    ...
    public function index() {
		...
		$GLOBALS['tmpl']->assign("page_title",$GLOBALS['lang']['GOLD_SAFE_TITLE']);
		$GLOBALS['tmpl']->assign("page_keyword",$GLOBALS['lang']['SHOP_KEYWORD']);
		$GLOBALS['tmpl']->assign("page_description",$GLOBALS['lang']['SHOP_DESCRIPTION']);
