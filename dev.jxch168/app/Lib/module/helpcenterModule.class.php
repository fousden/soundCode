...
//	    }
//			echo '<pre>';var_dump($cate_item);echo '</pre>';die;
	    $cate_id = intval($cate_item['id']);
	    $cate_tree = get_acate_tree(13);
	    ...
	    $result = get_article_list($limit, $cate_id, 'ac.type_id = 3', '');
//	    echo $cate_id;die;
//	    echo '<pre>';var_dump($result['list'][0]['cate_id']);echo '</pre>';die;
