...
class noticeModule extends SiteBaseModule
{
	...
	public function index()
	{
		...
		if (!$GLOBALS['tmpl']->is_cached('page/notice_index.html', $cache_id))
		{
			...
			$GLOBALS['tmpl']->assign("article_title",$article['seo_title']);
			$GLOBALS['tmpl']->assign("article_keyword",$article['seo_keyword']);
			$GLOBALS['tmpl']->assign("article_description",$article['seo_description']);
	...
	public function list_notice()
	{
		...
		if (!$GLOBALS['tmpl']->is_cached('page/notice_list.html', $cache_id))
		{
			...
			//输出当前的site_nav
			//页面关键词描述处理
			$GLOBALS['tmpl']->assign('page_title',$GLOBALS['lang']['SITE_NOTICE_TITLE']);
			$GLOBALS['tmpl']->assign('page_keyword',$GLOBALS['lang']['SITE_NOTICE_KEYWORD']);
			$GLOBALS['tmpl']->assign('page_description',$GLOBALS['lang']['SITE_NOTICE_DESCRIPTION']);
