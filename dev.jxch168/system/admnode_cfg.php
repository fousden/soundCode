...
return array(
    "Index,Statistics" => array(
        "name" => "系统首页",
        "node" => array(
            "main" => array("name" => "代办事务", "module" => "Index", "action" => "main"),
    ...
    "Finance" => array(
        "name" => "财务管理",
        "node" => array(
            "index" => array("name" => "入金操作", "module" => "Finance", "action" => "index"),
            "do_loans" => array("name" => "确认入金", "module" => "Finance", "action" => "do_loans"),
            "verify" => array("name" => "还款审核", "module" => "Finance", "action" => "verify"),
            "verify_deal" => array("name" => "确认审核", "module" => "Finance", "action" => "verify_deal"),
            "operate" => array("name" => "还款操作", "module" => "Finance", "action" => "operate"),
            "operate" => array("name" => "还款统计", "module" => "Finance", "action" => "repay_static"),
            "statistics_deal_repay"=>array("name" => "贷款统计", "module" => "StatisticsData", "action" => "statistics_deal_repay"),
            "do_site_repay" => array("name" => "确认还款", "module" => "Finance", "action" => "do_site_repay"),
            "passwdManange" => array("name" => "密码管理", "module" => "Finance", "action" => "passwdManange"),
            "flowingwater" => array("name" => "查看投标记录", "module" => "Finance", "action" => "flowingwater"),
            "admin_invite" => array("name" => "销售类投资订单记录", "module" => "Finance", "action" => "admin_invite"),
            "deal_load_static" => array("name" => "标的入金统计", "module" => "Finance", "action" => "deal_load_static"),
            "repay_list" => array("name" => "未还款列表", "module" => "Finance", "action" => "repay_list"),
            "repay_total" => array("name" => "已还款统计", "module" => "Finance", "action" => "repay_total"),
            'overdue'=>array("name" => "逾期还款列表", "module" => "Finance", "action" => "overdue"),
        )
    ),
    "Log" => array(
        "name" => "系统日志",
    ...
    "BonusManage,Option" => array(
        "name" => "红包管理",
        "node" => array(
            'bonusIdentify' => array("name" => "红包审核", "module" => "BonusManage", "action" => "bonusIdentify"),
            "bonus_verify" => array("name" => "红包确认审核", "module" => "BonusManage", "action" => "bonus_verify"),
            'bonusRepay' => array("name" => "红包放款", "module" => "BonusManage", "action" => "bonusRepay"),
            "bonus_repay" => array("name" => "红包确认放款", "module" => "BonusManage", "action" => "bonus_repay"),
            'pwdMan' => array("name" => "红包密码", "module" => "BonusManage", "action" => "pwdMan"),
        ),
    ),
    "UserReward,Option" => array(
        "name" => "提成管理",
        "node" => array(
            "rewardIdentify" => array("name" => "提成审核", "module" => "UserReward", "action" => "rewardIdentify"), //&type=identify
            "batch_verify" => array("name" => "提成确认审核", "module" => "UserReward", "action" => "batch_verify"),
            "rewardRepay" => array("name" => "提成放款", "module" => "UserReward", "action" => "rewardRepay"), //&type=repay
            "batch_repay" => array("name" => "提成确认放款", "module" => "UserReward", "action" => "batch_repay"),
            "pwdMan" => array("name" => "提成密码", "module" => "UserReward", "action" => "pwdMan")
        ),
    ),
    "Loads" => array(
        "name" => "投标记录",
        "node" => array(
            ...
            "rank" => array("name" => "投标排行榜", "action" => "rank"),
            "invite" => array("name" => "邀请排行榜", "action" => "invite"),
    ...
    "User,Option" => array(
        ...
        "node" => array(
            ...
            "private_info" => array("name" => "私人资料查看", "module" => "User", "action" => "private_info"),
            "send_welfare" => array("name" => "发放福利", "module" => "User", "action" => "send_welfare"),
        )
    ),
    "DealAgency" => array(
        "name" => "担保机构",
    ...
    "UserBonus" => array(
        "name" => "红包管理",
        "node" => array(
            'bonus_no_loans' => array("name" => "待放款红包", "action" => "bonus_no_loans"),
            'bonus_yes_loans' => array("name" => "已放款红包", "action" => "bonus_yes_loans"),
            'bonus_wait_carry' => array("name" => "红包查询", "action" => "bonus_wait_carry"),
        ),
    ),
    "UserCoupon" => array(
        "name" => "优惠券管理",
        "node" => array(
            'third_coupon' => array("name" => "第三方优惠券", "action" => "third_coupon")
        ),
    ),
    ...
    "lottery" => array(
        "name" => "活动奖品信息",
        "node" => array(
            'index' => array("name" => "奖品列表", "module" => "Lottery", "action" => "index"),
            'coupon_index' => array("name" => "优惠券列表", "module" => "Lottery", "action" => "coupon_index"),
            'entity_index' => array("name" => "实物列表", "module" => "Lottery", "action" => "entity_index"),
        ),
    ),
    "JxchTravel" => array(
        "name" => "金享旅游活动",
        "node" => array(
            'invest' => array("name" => "投资列表", "module" => "JxchTravel", "action" => "invest"),
            'invite' => array("name" => "推荐列表", "module" => "JxchTravel", "action" => "invite"),
        ),
    ),
    ...
    "User,MoneyLog" => array(
        "name" => "手动操作显示",
        "node" => array(
            "update_hand_recharge" => array("name" => "快速充值", "module" => "User", "action" => "hand_recharge"),
            "update_hand_overdue" => array("name" => "快速扣款", "module" => "User", "action" => "hand_overdue"),
            "update_hand_freeze" => array("name" => "冻结资金", "module" => "User", "action" => "hand_freeze"),
            "update_hand_integral" => array("name" => "变更积分", "module" => "User", "action" => "hand_integral"),
            "update_hand_quota" => array("name" => "变更额度", "module" => "User", "action" => "hand_quota"),
        )
    ),
    "User,update" => array(
        "name" => "手动操作执行",
        "node" => array(
            "update_hand_recharge" => array("name" => "快速充值编辑", "module" => "User", "action" => "update_hand_recharge"),
            "update_hand_overdue" => array("name" => "快速扣款提交", "module" => "User", "action" => "update_hand_overdue"),
            "update_hand_freeze" => array("name" => "冻结资金编辑", "module" => "User", "action" => "update_hand_freeze"),
            "update_hand_integral" => array("name" => "变更积分编辑", "module" => "User", "action" => "update_hand_integral"),
            "update_hand_quota" => array("name" => "变更额度编辑", "module" => "User", "action" => "update_hand_quota"),
        )
    ),
    ...
    "WebsiteStatistics" => array(
        "name" => "平台统计",
        "node" => array(
            "website_invest_total" => array("name" => "投标统计", "action" => "website_invest_total"),
            "website_invest_oto" => array("name" => "投标渠道统计", "action" => "website_invest_oto"),
            "website_recharge_total" => array("name" => "充值统计", "action" => "website_recharge_total"),
            "website_recharge_oto" => array("name" => "充值渠道统计", "action" => "website_recharge_oto"),
            "incharge_feed_back" => array("name" => "充值反馈统计", "action" => "incharge_feed_back"),
            "website_recharge_rank" => array("name" => "充值排行榜", "action" => "website_recharge_rank"),
            "website_extraction_cash" => array("name" => "资金对比", "action" => "website_extraction_cash"),
            "website_extraction_rank" => array("name" => "提现排行榜", "action" => "website_extraction_rank"),
            ...
            'website_login_info' => array("name" => "登录日志统计", "action" => "website_login_info"),
            "website_gold_info" => array("name" => "入金统计", "action" => "website_gold_info"),
        )
    ),
    "Extension" => array(
        "name" => "IOS渠道统计",
        "node" => array(
            'index' => array("name" => "IOS渠道统计", "action" => "index"),
        )
    ),
    "StatisticsPopulog" => array(
        "name" => "注册统计",
        "node" => array(
            "statistics_sum" => array("name" => "注册总计", "action" => "statistics_sum"),
            "statistics_user" => array("name" => "注册渠道统计", "action" => "statistics_user"),
            "statistical_pt" => array("name" => "注册平台统计", "action" => "statistical_pt"),
            "statistics_qd" => array("name" => "推广来源统计", "action" => "statistics_qd"),
            "statistics_yqly" => array("name" => "邀请来源统计", "action" => "statistics_yqly"),
            "statistics_yqqd" => array("name" => "邀请渠道统计", "action" => "statistics_yqqd"),
        )
    ),
    "StatisticsPopulogBk" => array(
        "name" => "绑卡统计",
        "node" => array(
            "statistics_bksum" => array("name" => "绑卡总计", "action" => "statistics_bksum"),
            "statistics_bkly" => array("name" => "绑卡来源统计", "action" => "statistics_bkly"),
            "statistics_bkqd" => array("name" => "绑卡平台统计", "action" => "statistics_bkqd"),
        )
    ),
    "StatisticsBigData" => array(
        "name" => "大数据统计",
        "node" => array(
            "StatisticsBigData_deal_time" => array("name" => "实时统计", "action" => "StatisticsBigData_deal_time"),
            "StatisticsBigData_deal_map" => array("name" => "地图统计", "action" => "StatisticsBigData_deal_map"),
        )
    ),
    "StatisticsData" => array(
        "name" => "运营渠道统计",
        "node" => array(
            "statistics_terrace" => array("name" => "平台报表统计", "action" => "statistics_terrace"),
            "statistics_user" => array("name" => "用户信息统计", "action" => "statistics_user"),
        ),
    ),
    "Globalmoney" => array(
        "name" => "全局资金",
        "node" => array(
            "statistics_terrace" => array("name" => "资金流向", "action" => "index"),
        ),
    ),
    "Department,Option" => array(
        "name" => "部门管理",
        "node" => array(
            "myindex" => array("name" => "我的主页", "module" => "MyMembership", "action" => "myindex"),
    ...
    "OverdueBillMonth,Option" => array(
        ...
        "node" => array(
            ...
            "user_populog" => array("name" => "会员投资记录", "module" => "User", "action" => "user_populog"),
        )
    ),
    "Goods,Option" => array(
        "name" => "积分商城",
    ...
    "DealMsgList" => array(
        ...
        "node" => array(
            ...
            "statistics"=>array("name" => "业务队列统计", "module" => "DealMsgList", "action" => "statistics"),
    ...
    "MsgPush" => array(
        "name" => "客户端推送",
        "node" => array(
            "index" => array("name" => "推送列表", "action" => "index"),
        )
    ),
    "AndroidPush" => array(
        "name" => "安卓推送",
        "node" => array(
            "index" => array("name" => "安卓推送", "action" => "index"),
        )
    ),
    "Article" => array(
        "name" => "文章模块",
    ...
    "Notice" => array(
        "name" => "文章模块",
        "node" => array(
            "index" => array("name" => "公告列表", "action" => "index"),
            "insert" => array("name" => "添加执行", "action" => "insert"),
            "update" => array("name" => "编辑执行", "action" => "update"),
            "set_effect" => array("name" => "设置生效", "action" => "set_effect"),
            "set_sort" => array("name" => "排序", "action" => "set_sort"),
    ...
    "Feedback" => array(
        "name" => "反馈信息",
        "node" => array(
            "index" => array("name" => "反馈列表", "action" => "index")
        )
    ),
    /*
      "EcvType"	=>	array(
     ...
     */
    "Conf,UserCarry,Bank,Credit,Ad" => array(
        "name" => "系统配置",
        "node" => array(
            ...
            "Activity_index" => array("name" => "活动参数设置", "module" => "ActivityConf", "action" => "index"),
            "Activity_insert" => array("name" => "添加活动", "module" => "ActivityConf", "action" => "insert"),
            "Activity_update" => array("name" => "编辑活动", "module" => "ActivityConf", "action" => "update"),
            "Ad_index" => array("name" => "前端广告列表", "module" => "Ad", "action" => "index"),
            "Ad_insert" => array("name" => "新增广告", "module" => "Ad", "action" => "insert"),
            "Ad_update" => array("name" => "编辑广告", "module" => "Ad", "action" => "update"),
            "Ad_foreverdelete" => array("name" => "永久删除广告", "module" => "Ad", "action" => "foreverdelete"),
            "ImportantNotice_index" => array("name" => "移动端通告", "module" => "ImportantNotice", "action" => "index"),
        )
    ),
    ...
    "Service,Pingan,Recharge,Matter" => array(
        "name" => "客服管理",
        "node" => array(
            array("name" => "充值反馈", "module" => "Service", "action" => "index"),
            array("name" => "平安网银安全卫士", "module" => "Pingan", "action" => "index"),
            array("name" => "充值异常", "module" => "Recharge", "action" => "index"),
            array("name" => "充值掉单处理", "module" => "PaymentNotice", "action" => "incharge_manage"),
            array("name" => "提现掉单处理", "module" => "UserCarry", "action" => "cash_manage"),
            array("name" => "提现查询", "module" => "UserCarry", "action" => "inquiry"),
            array("name" => "抽奖日志", "module" => "Matter", "action" => "index"),
            array("name" => "基金联系人", "module" => "Fund", "action" => "index"),
            array("name" => "手机黑名单", "module" => "Blacklist", "action" => "index"),
            array("name" => "客户端崩溃日志", "module" => "MobileAnomalyLog", "action" => "index"),
            array("name" => "我要贷款", "module" => "Loan", "action" => "index"),
            array("name" => "更换银行卡申请列表", "module" => "Service", "action" => "changeBank"),
            array("name" => "客户收货地址管理", "module" => "UserAddress", "action" => "index"),
            array("name" => "客户反馈信息", "module" => "Feedback", "action" => "index"),
            array("name" => "修改推荐人", "module" => "ChangeReferee", "action" => "index"),
        )
    ),
);
?>