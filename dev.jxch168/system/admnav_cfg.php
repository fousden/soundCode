    ...
    "Finance" => array(
        ...
        "groups" => array(
            "flowingwater" => array(
                ...
                "key" => "flowingwater",
                "nodes" => array(
                    array("name" => "入金操作", "module" => "Finance", "action" => "index"),
                    array("name" => "还款审核", "module" => "Finance", "action" => "verify"),
                    array("name" => "还款操作", "module" => "Finance", "action" => "operate"),
                    array("name" => "还款统计", "module" => "Finance", "action" => "repay_static"),
                    array("name" => "贷款统计", "module" => "StatisticsData", "action" => "statistics_deal_repay"),
                    array("name" => "密码管理", "module" => "Finance", "action" => "passwdManange"),
                    array("name" => "查看投标记录", "module" => "Finance", "action" => "flowingwater"),
                    array("name" => "销售类投资订单记录", "module" => "Finance", "action" => "admin_invite"),
                    array("name" => "标的入金统计", "module" => "Finance", "action" => "deal_load_static"),
                    array("name" => "未还款列表", "module" => "Finance", "action" => "repay_list"),
                    array("name" => "已还款统计", "module" => "Finance", "action" => "repay_total"),
                    array("name" => "逾期还款列表", "module" => "Finance", "action" => "overdue"),
                ),
            ),
            "BonusManage" => array(
                "name" => "红包管理",
                "key" => "BonusManage",
                "nodes" => array(
                    array("name" => "红包审核", "module" => "BonusManage", "action" => "bonusIdentify"), //&type=identify
                    array("name" => "红包放款", "module" => "BonusManage", "action" => "bonusRepay"), //&type=repay
                    array("name" => "红包密码", "module" => "BonusManage", "action" => "pwdMan")
                ),
            ),
            "UserReward" => array(
                "name" => "提成管理",
                "key" => "UserReward",
                "nodes" => array(
                    array("name" => "提成审核", "module" => "UserReward", "action" => "rewardIdentify"), //&type=identify
                    array("name" => "提成放款", "module" => "UserReward", "action" => "rewardRepay"), //&type=repay
                    array("name" => "提成密码", "module" => "UserReward", "action" => "pwdMan")
                ),
            ),
        ),
    ),
        ...
        "groups" => array(
            ...
            "loads" => array(
                ...
                "nodes" => array(
                    ...
                    array("name" => "投标排行榜", "module" => "Loads", "action" => "rank"),
                    array("name" => "邀请排行榜", "module" => "Loads", "action" => "invite"),
...
//										array("name"=>"VIP等级回收站","module"=>"VipType","action"=>"vip_type_trash"),
            ...
            "bonus" => array(
                ...
                "key" => "bonus",
                "nodes" => array(
                    array("name" => "待放款红包", "module" => "UserBonus", "action" => "bonus_no_loans"),
                    array("name" => "已放款红包", "module" => "UserBonus", "action" => "bonus_yes_loans"),
                    array("name" => "红包查询", "module" => "UserBonus", "action" => "bonus_wait_carry"),
                ),
            ),
            "coupon" => array(
                "name" => "优惠券管理",
                "key" => "coupon",
                "nodes" => array(
                    array("name" => "第三方优惠券", "module" => "UserCoupon", "action" => "third_coupon")
                ),
            ),
            "welfare" => array(
                "name" => "节日福利",
...
//										array("name"=>"节日积分回收站","module"=>"VipFestivals","action"=>"festivals_trash"),
            ...
            "lottery" => array(
                ...
                "key" => "lottery",
                "nodes" => array(
                    array("name" => "奖品列表", "module" => "Lottery", "action" => "index"),
                    array("name" => "优惠券列表", "module" => "Lottery", "action" => "coupon_index"),
                    array("name" => "实物列表", "module" => "Lottery", "action" => "entity_index"),
                    array("name" => "旅游活动大礼包", "module" => "Lottery", "action" => "jxch_travel"),
                ),
            ),
            "JxchTravel" => array(
                "name" => "金享旅游活动",
                "key" => "jxch_travel",
                "nodes" => array(
                    array("name" => "投资列表", "module" => "JxchTravel", "action" => "invest"),
                    array("name" => "推荐列表", "module" => "JxchTravel", "action" => "invite"),
                ),
            ),
        ),
    ),
    ...
    "statistics" => array(
        ...
        "groups" => array(
            ...
            "website_statistics" => array(
                ...
                "nodes" => array(
                    array("name" => "投标统计", "module" => "WebsiteStatistics", "action" => "website_invest_total"),
                    array("name" => "投标渠道统计", "module" => "WebsiteStatistics", "action" => "website_invest_oto"),
                    array("name" => "充值统计", "module" => "WebsiteStatistics", "action" => "website_recharge_total"),
                    array("name" => "充值渠道统计", "module" => "WebsiteStatistics", "action" => "website_recharge_oto"),
                    array("name" => "充值反馈统计", "module" => "WebsiteStatistics", "action" => "incharge_feed_back"),
                    array("name" => "充值排行榜", "module" => "WebsiteStatistics", "action" => "website_recharge_rank"),
                    array("name" => "资金对比", "module" => "WebsiteStatistics", "action" => "website_extraction_cash"),
                    array("name" => "提现排行榜", "module" => "WebsiteStatistics", "action" => "website_extraction_rank"),
                    ...
                    array("name" => "登录日志统计", "module" => "WebsiteStatistics", "action" => "website_login_info"),
                    array("name" => "入金统计", "module" => "WebsiteStatistics", "action" => "website_gold_info"),
                    array("name" => "IOS渠道统计", "module" => "Extension", "action" => "index"),
                ),
            ),
            "StatisticsPopulog" => array(
                "name" => "注册统计",
                "key" => "StatisticsPopulog",
                "nodes" => array(
                    array("name" => "注册总计", "module" => "StatisticsPopulog", "action" => "statistics_sum"),
                    array("name" => "注册渠道统计", "module" => "StatisticsPopulog", "action" => "statistics_user"),
                    array("name" => "注册平台统计", "module" => "StatisticsPopulog", "action" => "statistical_pt"),
                    array("name" => "推广来源统计", "module" => "StatisticsPopulog", "action" => "statistics_qd"),
                    array("name" => "邀请来源统计", "module" => "StatisticsPopulog", "action" => "statistics_yqly"),
                    array("name" => "邀请渠道统计", "module" => "StatisticsPopulog", "action" => "statistics_yqqd"),
                ),
            ),
            "StatisticsPopulogBk" => array(
                "name" => "绑卡统计",
                "key" => "StatisticsPopulogBk",
                "nodes" => array(
                    array("name" => "绑卡总计", "module" => "StatisticsPopulogBk", "action" => "statistics_bksum"),
                    array("name" => "绑卡来源统计", "module" => "StatisticsPopulogBk", "action" => "statistics_bkly"),
                    array("name" => "绑卡平台统计", "module" => "StatisticsPopulogBk", "action" => "statistics_bkpt"),
                ),
            ),
            "StatisticsBigData" => array(
                "name" => "大数据统计",
                "key" => "StatisticsBigData",
                "nodes" => array(
                    array("name" => "实时统计", "module" => "StatisticsBigData", "action" => "StatisticsBigData_deal_time"),
                    array("name" => "地图统计", "module" => "StatisticsBigData", "action" => "StatisticsBigData_deal_map"),
                ),
            ),
            "StatisticsData" => array(
                ...
                "key" => "StatisticsData",
                "nodes" => array(
                    array("name" => "平台报表统计", "module" => "StatisticsData", "action" => "statistics_terrace"),
                    array("name" => "用户信息统计", "module" => "StatisticsData", "action" => "statistics_user"),
                ),
            ),
            "Globalmoney" => array(
                "name" => "全局资金",
                "key" => "Globalmoney",
                "nodes" => array(
                    array("name" => "资金流向", "module" => "Globalmoney", "action" => "index"),
                ),
            ),
        ),
    ),
        ...
        "groups" => array(
            ...
            "msglist" => array(
                ...
                "nodes" => array(
                    ...
                    array("name" => "业务队列统计", "module" => "DealMsgList", "action" => "statistics"),
            ...
            "msgpush" => array(
                ...
                "key" => "msgpush",
                "nodes" => array(
                    array("name" => "推送列表", "module" => "MsgPush", "action" => "index"),
                ),
            ),
        ),
    ),
        ...
        "groups" => array(
            "article" => array(
                ...
                "nodes" => array(
                    ...
                    array("name" => "公告列表", "module" => "Notice", "action" => "index"),
            ...
            "feedback" => array(
                ...
                "key" => "feedback",
                "nodes" => array(
                    array("name" => "反馈信息", "module" => "Feedback", "action" => "index"),
                ),
            ),
        ),
    ),
        ...
        "groups" => array(
            "sysconf" => array(
                ...
                "nodes" => array(
                    ...
                    array("name" => "活动参数设置", "module" => "ActivityConf", "action" => "index"),
                    array("name" => "前端广告列表", "module" => "Ad", "action" => "index"),
                    array("name" => "移动端通告", "module" => "ImportantNotice", "action" => "index"),
                ),
            ),
            "dealconfig" => array(
                "name" => "贷款设置",
    ...
    "department" => array(
        ...
        "groups" => array(
            "admin_manage" => array(
                ...
                "key" => "admin_manage",
                "nodes" => array(
                    array("name" => "我的主页", "module" => "MyMembership", "action" => "myindex"),
            ...
            "member_bill" => array(
                ...
                "nodes" => array(
                    ...
                    array("name" => "会员投资记录", "module" => "User", "action" => "user_populog"),
                ),
            ),
        ),
    ),
