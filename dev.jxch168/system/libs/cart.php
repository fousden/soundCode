...
function payment_paid($payment_notice_id, $outer_notice_sn = '')
{
	...
	$GLOBALS['db']->query("update ".DB_PREFIX."payment_notice set resp_describle = '充值成功',pay_time = ".$now.", pay_date = '".to_date($now,'Y-m-d')."',outer_notice_sn = '".$outer_notice_sn."',is_paid = 1 where id = ".$payment_notice_id." and is_paid = 0");
