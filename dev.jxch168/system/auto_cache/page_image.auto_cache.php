...
class page_image_auto_cache extends auto_cache{
	public function load($param)
	{
		...
		if($image_str === false)
		{
			...
			{
				$image_str = "<span style='display:inline-block; width:".intval($info['width'])."px; height:".intval($info['height'])."px; background:url(".$img_path.") no-repeat; _filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src=".$img_path.", sizingMethod=scale);_background-image:none;margin-top:20px;'></span>";
			}
			else
			{
