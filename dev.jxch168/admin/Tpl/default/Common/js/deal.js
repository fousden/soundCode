...
function deal_status_click(obj){
	...
	switch($(obj).val()){
		case "1":
			...
			$("#qixi_time_box").show();
			$("#jiexi_time_box").show();
			$("#last_mback_time_box").show();
			$("#start_time_box #start_time").addClass("require");
			$("#qixi_time_box #start_time").addClass("require");
			$("#jiexi_time_box #start_time").addClass("require");
			$("#last_mback_time_box #start_time").addClass("require");
			break;
		default :
			$("#start_time_box").hide();
			$("#qixi_time_box").hide();
			$("#jiexi_time_box").hide();
			$("#last_mback_time_box").hide();
			break;
	}
};
