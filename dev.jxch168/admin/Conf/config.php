...
//引入活动配置
if(file_exists(APP_ROOT_PATH.'data_conf/mid_autumn_active.php')){
    $active_config = require_once APP_ROOT_PATH.'data_conf/mid_autumn_active.php';
}
...
if(file_exists(APP_ROOT_PATH.'data_conf/mid_autumn_active.php')){
    $config = array_merge($config,$active_config);
}
return $config;
